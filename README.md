[![Build Status](https://travis-ci.org/abrahamoshel/rails-travis-example.svg)](https://travis-ci.org/abrahamoshel/rails-travis-example) [![Code Climate](https://codeclimate.com/github/secure-pipeline/rails-travis-example.png)](https://codeclimate.com/github/secure-pipeline/rails-travis-example)
